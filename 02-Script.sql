...
INSERT INTO table_restaurant_inspection_dataset ("CAMIS",
                                                 "DBA",
                                                 "BORO",
                                                 "BUILDING",
                                                 "STREET",
...
SELECT *
FROM table_restaurant_inspection_dataset where "ID"=202669 ;
...
INSERT INTO table_restaurant (ID,CAMIS, DBA, PHONE, ADDRESS_ID, CUISINE_ID)
SELECT r."ID",r."CAMIS",
       r."DBA",
       r."PHONE",
       ta."id" as ADDRESS_ID,
...
FROM table_restaurant_inspection_dataset r
         ...
         LEFT JOIN table_cuisine c ON r."CUISINE DESCRIPTION" = c.type;
--     where r."ID" = 202669 ;
...
SELECT *
FROM table_restaurant where id = 202669 ;
...
SELECT * FROM table_restaurant_inspection_dataset ORDER BY "ID";

INSERT INTO table_results
    (id,action_id, critical_flag_id, grade_type_id, "SCORE")
SELECT rid."ID",a.id  AS action_id,
...
(
    ...
    CONSTRAINT fk_inspection_type FOREIGN KEY (INSPECTION_TYPE_ID) REFERENCES table_inspection_type (id),
